...
const GeneralStatsSubSection = props => {
  ...
  return (
    <div>
      <Tabs className={classes.tabs} value={value} onChange={handleChange} aria-label="general stats tabs" centered>
      <Tab label="Employees Employed" {...a11yProps(0)} />
      <Tab label="Status of Business" {...a11yProps(1)} />
      </Tabs>
      <TabPanel value={value} index={0}>
        <LollipopChart id={"numemploy_svg"} key={1} data={props.numemploy_counts}/>
      </TabPanel>
      <TabPanel value={value} index={1}>
        <LollipopChart id={"bizstatus_svg"} key={2} data={props.bizstatus_counts}/>
      </TabPanel>
    </div>
  )
}
...
const FemaleOwnedSubSection = props => {
  ...
  return (
    <div>
      <Tabs className={classes.tabs} value={value} onChange={handleChange} aria-label="female ownership tabs" centered>
    ...
    <div className={classes.section}>
      <GridContainer justify="center">
        <GridItem cs={12} sm={12} md={8}>
          ...
          <GeneralStatsSubSection bizstatus_counts={props.bizstatus_counts} numemploy_counts={props.numemploy_counts} />
          <h4 className={classes.description}>
