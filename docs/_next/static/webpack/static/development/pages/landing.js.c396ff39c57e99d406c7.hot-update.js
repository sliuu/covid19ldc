...
function HorizontalBarChart(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    ...
    chart.append("g").attr("transform", "translate(0," + height + ")").call(d3__WEBPACK_IMPORTED_MODULE_3__["axisBottom"](x).ticks((margin.left + width) / 100, "%")).selectAll("text").attr("transform", "translate(-10,0)rotate(-45)").style("text-anchor", "end");
...
//# sourceMappingURL=landing.js.c396ff39c57e99d406c7.hot-update.js.map