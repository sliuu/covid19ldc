...
function HorizontalBarChart(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    ...
    var x = d3__WEBPACK_IMPORTED_MODULE_3__["scaleLinear"]().range([margin.left, width - margin.right]);
    chart.append("g").attr("transform", "translate(0," + height + ")").call(d3__WEBPACK_IMPORTED_MODULE_3__["axisBottom"](x).ticks((margin.left, width - margin.right) / 100, "%")).selectAll("text").attr("transform", "translate(-10,0)rotate(-45)").style("text-anchor", "end");
...
//# sourceMappingURL=landing.js.a2d338ee9da6827a1de3.hot-update.js.map