...
function HorizontalBarChart(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    ...
    chart.selectAll("myRect").data(data).enter().append("rect").attr("x", margin.left).attr("width", function (d) {
      return x(d.value);
    }).attr("y", function (d) {
      return y(d.key);
...
//# sourceMappingURL=landing.js.7c1c993452825e703f60.hot-update.js.map