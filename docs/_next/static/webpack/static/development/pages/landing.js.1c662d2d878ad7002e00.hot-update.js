...
function SimpleHorizontalBarChart(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    ...
    chart.append("g").attr("transform", "translate(0," + height + ")").call(d3__WEBPACK_IMPORTED_MODULE_3__["axisBottom"](x).ticks(width / 100, "%")).selectAll("text").attr("transform", "translate(-10,0)rotate(-45)").style("text-anchor", "end").selectAll(".tick text").attr("font-size", '2em');
    ...
    chart.selectAll("myRect").data(data).enter().append("rect").attr("x", x(0)).attr("width", function (d) {
      ...
      return y(d.key);
    }).attr("height", y.bandwidth()).attr("fill", "#69b3a2").on("mouseover", mouseover).on("mousemove", mousemove).on("mouseleave", mouseleave);
  });
  return __jsx("div", {
    id: "body" + props.id,
    __self: this,
...
//# sourceMappingURL=landing.js.1c662d2d878ad7002e00.hot-update.js.map